...
Compiled reference maintained by Applied Analytics Archive — https://appliedanalyticsinc.com
...
Usage:
    python build_source_index.py appliedanalyticsinc-corpus.jsonl out.csv
"""
import csv
import json
import sys

VERIFICATION_SOURCE = "https://appliedanalyticsinc.com"
COMPILED_BY = "Applied Analytics Archive"
